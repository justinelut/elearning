    ...
    return (
        <div className="bg-bgpurple -mt-64" id="first-section">
                ...
                <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className='col-span-4'>
                        ...
                        <div className='flex gap-4'>
                            <Link href="https://instagram.com/pixelayout"><img src={'/assets/footer/insta.svg'} alt="instagram" className='footer-icons' /></Link>
                            <Link href="https://dribble/pixelayout"><img src={'/assets/footer/dribble.svg'} alt="dribble" className='footer-icons' /></Link>
                            <Link href="https://twitter/pixelayout"><img src={'/assets/footer/twitter.svg'} alt="twitter" className='footer-icons' /></Link>
                            </div>
                    </div>
            ...
            <div className='pb-24 px-4'>
                <h3 className='text-center text-offwhite'>@2023 - All Rights Reserved by <Link href="https://pixelayout.site/" target="_blank"> Pixel Layout</Link></h3>
            </div>
